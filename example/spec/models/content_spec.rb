...
RSpec.describe Content, type: :model do
  ...
  it 'balances contents by category' do
    ...
    balanced = Content.all.balance_by_type(type_field: :category).pluck(:category)
  ...
  it 'balances contents by content_type' do
    ...
    balanced = Content.all.balance_by_type(type_field: :content_type).pluck(:content_type)
    expect(balanced).not_to eq(original)
